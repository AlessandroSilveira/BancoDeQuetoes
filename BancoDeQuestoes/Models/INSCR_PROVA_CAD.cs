namespace BancoDeQuestoes.Models
{
    ...
    public partial class INSCR_PROVA_CAD
    {
        [Key]
        public int ID_PROVA_CAD { get; set; }
        ...
        [StringLength(100)]
        public string DESC_DATA_ENVIO_ARQUIVO { get; set; }

        public virtual INSCR_CAD INSCR_CAD { get; set; }

        public virtual INSCR_PROVA_PROCESSO_LOCAL INSCR_PROVA_PROCESSO_LOCAL { get; set; }

        public virtual INSCR_PROVA_PROCESSO_LOCAL_SALA INSCR_PROVA_PROCESSO_LOCAL_SALA { get; set; }
    }
}
