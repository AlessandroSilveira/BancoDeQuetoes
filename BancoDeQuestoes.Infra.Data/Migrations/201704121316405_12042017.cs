namespace BancoDeQuestoes.Infra.Data.Migrations
{
    ...
    public partial class _12042017 : DbMigration
    {
        ...
        public override void Down()
        {
            ...
            DropTable("dbo.Banca");
            CreateIndex("dbo.INSCR_ADMIN_PERFIL", "ID_ADMIN");
            CreateIndex("dbo.MestreDependente", "INSCR_BQ_MESTRE_ID_MESTRE");
            CreateIndex("dbo.INSCR_BQ_MESTRE_FORMACAO", "ID_MESTRE");
            CreateIndex("dbo.INSCR_BQ_RESPOSTA", "ID_QUESTAO");
            CreateIndex("dbo.INSCR_BQ_RESPOSTA", "ID_TOPICO_ATRIBUIDO");
            CreateIndex("dbo.INSCR_BQ_RESPOSTA_REVISADA", "Revisor_RevisorId");
            CreateIndex("dbo.INSCR_BQ_RESPOSTA_REVISADA", "ID_TOPICO_ATRIBUIDO");
            CreateIndex("dbo.INSCR_BQ_RESPOSTA_REVISADA", "ID_QUESTAO");
            CreateIndex("dbo.INSCR_BQ_RESPOSTA_REVISADA", "ID_RESPOSTA");
            CreateIndex("dbo.INSCR_BQ_QUESTAO_REVISOR", "Revisor_RevisorId");
            CreateIndex("dbo.INSCR_BQ_QUESTAO_REVISOR", "ID_QUESTAO");
            CreateIndex("dbo.INSCR_BQ_QUESTAO_PROJETO", "Projeto_ProjetoId");
            CreateIndex("dbo.INSCR_BQ_QUESTAO_PROJETO", "ID_QUESTAO_REVISADA");
            CreateIndex("dbo.INSCR_BQ_QUESTAO_REVISADA", "Revisor_RevisorId");
            CreateIndex("dbo.INSCR_BQ_QUESTAO_REVISADA", "ID_TOPICO_ATRIBUIDO");
            CreateIndex("dbo.INSCR_BQ_QUESTAO_REVISADA", "ID_QUESTAO");
            CreateIndex("dbo.INSCR_BQ_QUESTAO_RECICLAR_REVISOR", "Revisor_RevisorId");
            CreateIndex("dbo.INSCR_BQ_QUESTAO_RECICLAR_REVISOR", "ID_QUESTAO");
            CreateIndex("dbo.INSCR_BQ_CONVITE_REVISOR", "Revisor_RevisorId");
            CreateIndex("dbo.INSCR_BQ_CONVITE_REVISOR", "ID_QUESTAO");
            CreateIndex("dbo.INSCR_BQ_QUESTAO", "ID_TOPICO_ATRIBUIDO");
            CreateIndex("dbo.INSCR_BQ_CONVITE_REVISAO_MESTRE", "ID_QUESTAO");
            CreateIndex("dbo.INSCR_BQ_CONVITE_REVISAO_MESTRE", "ID_MESTRE");
            CreateIndex("dbo.INSCR_BQ_MESTRE", "ID_BANCA");
            CreateIndex("dbo.INSCR_BQ_CONVITE_MESTRE", "ID_TOPICO_ATRIBUIDO");
            CreateIndex("dbo.INSCR_BQ_CONVITE_MESTRE", "ID_MESTRE");
            CreateIndex("dbo.INSCR_BQ_TOPICO_ATRIBUIDO", "INSCR_BQ_DISCIPLINA_ID_DISCIPLINA");
            CreateIndex("dbo.INSCR_BQ_TOPICO_ATRIBUIDO", "Projeto_ProjetoId");
            CreateIndex("dbo.INSCR_BQ_TOPICO_ATRIBUIDO", "INSCR_BQ_CARGO_CBO_ID_CARGO_CBO");
            CreateIndex("dbo.INSCR_BQ_TOPICO_ATRIBUIDO", "Disciplina_DisciplinaId");
            CreateIndex("dbo.INSCR_BQ_TOPICO_ATRIBUIDO", "ID_MESTRE");
            CreateIndex("dbo.INSCR_BQ_TOPICO_ATRIBUIDO", "AreaId");
            CreateIndex("dbo.Disciplina", "INSCR_BQ_DISCIPLINA_ID_DISCIPLINA");
            CreateIndex("dbo.Disciplina", "INSCR_BQ_CARGO_CBO_ID_CARGO_CBO");
            CreateIndex("dbo.INSCR_BQ_TOP_DISC_CARGO", "Area_AreaId");
            CreateIndex("dbo.INSCR_BQ_TOP_DISC_CARGO", "Projeto_ProjetoId");
            CreateIndex("dbo.INSCR_BQ_TOP_DISC_CARGO", "INSCR_BQ_CARGO_CBO_ID_CARGO_CBO");
            CreateIndex("dbo.INSCR_BQ_TOP_DISC_CARGO", "Disciplina_DisciplinaId");
            CreateIndex("dbo.INSCR_BQ_TOP_DISC_CARGO", "ID_DISCIPLINA");
            AddForeignKey("dbo.INSCR_ADMIN_PERFIL", "ID_ADMIN", "dbo.INSCR_ADMIN", "ID_ADMIN");
            AddForeignKey("dbo.INSCR_BQ_TOP_DISC_CARGO", "Area_AreaId", "dbo.Area", "AreaId");
            AddForeignKey("dbo.INSCR_BQ_TOPICO_ATRIBUIDO", "INSCR_BQ_DISCIPLINA_ID_DISCIPLINA", "dbo.INSCR_BQ_DISCIPLINA", "ID_DISCIPLINA");
            AddForeignKey("dbo.Disciplina", "INSCR_BQ_DISCIPLINA_ID_DISCIPLINA", "dbo.INSCR_BQ_DISCIPLINA", "ID_DISCIPLINA");
            AddForeignKey("dbo.INSCR_BQ_TOP_DISC_CARGO", "ID_DISCIPLINA", "dbo.INSCR_BQ_DISCIPLINA", "ID_DISCIPLINA");
            AddForeignKey("dbo.INSCR_BQ_CONVITE_MESTRE", "ID_TOPICO_ATRIBUIDO", "dbo.INSCR_BQ_TOPICO_ATRIBUIDO", "ID_TOPICO_ATRIBUIDO");
            AddForeignKey("dbo.MestreDependente", "INSCR_BQ_MESTRE_ID_MESTRE", "dbo.INSCR_BQ_MESTRE", "ID_MESTRE");
            AddForeignKey("dbo.INSCR_BQ_TOPICO_ATRIBUIDO", "ID_MESTRE", "dbo.INSCR_BQ_MESTRE", "ID_MESTRE");
            AddForeignKey("dbo.INSCR_BQ_MESTRE_FORMACAO", "ID_MESTRE", "dbo.INSCR_BQ_MESTRE", "ID_MESTRE");
            AddForeignKey("dbo.INSCR_BQ_QUESTAO", "ID_TOPICO_ATRIBUIDO", "dbo.INSCR_BQ_TOPICO_ATRIBUIDO", "ID_TOPICO_ATRIBUIDO");
            AddForeignKey("dbo.INSCR_BQ_RESPOSTA_REVISADA", "Revisor_RevisorId", "dbo.Revisor", "RevisorId");
            AddForeignKey("dbo.INSCR_BQ_RESPOSTA_REVISADA", "ID_TOPICO_ATRIBUIDO", "dbo.INSCR_BQ_TOPICO_ATRIBUIDO", "ID_TOPICO_ATRIBUIDO");
            AddForeignKey("dbo.INSCR_BQ_RESPOSTA", "ID_TOPICO_ATRIBUIDO", "dbo.INSCR_BQ_TOPICO_ATRIBUIDO", "ID_TOPICO_ATRIBUIDO");
            AddForeignKey("dbo.INSCR_BQ_RESPOSTA_REVISADA", "ID_RESPOSTA", "dbo.INSCR_BQ_RESPOSTA", "ID_RESPOSTA");
            AddForeignKey("dbo.INSCR_BQ_RESPOSTA", "ID_QUESTAO", "dbo.INSCR_BQ_QUESTAO", "ID_QUESTAO");
            AddForeignKey("dbo.INSCR_BQ_RESPOSTA_REVISADA", "ID_QUESTAO", "dbo.INSCR_BQ_QUESTAO", "ID_QUESTAO");
            AddForeignKey("dbo.INSCR_BQ_QUESTAO_REVISOR", "Revisor_RevisorId", "dbo.Revisor", "RevisorId");
            AddForeignKey("dbo.INSCR_BQ_QUESTAO_REVISOR", "ID_QUESTAO", "dbo.INSCR_BQ_QUESTAO", "ID_QUESTAO");
            AddForeignKey("dbo.INSCR_BQ_QUESTAO_REVISADA", "Revisor_RevisorId", "dbo.Revisor", "RevisorId");
            AddForeignKey("dbo.INSCR_BQ_QUESTAO_REVISADA", "ID_TOPICO_ATRIBUIDO", "dbo.INSCR_BQ_TOPICO_ATRIBUIDO", "ID_TOPICO_ATRIBUIDO");
            AddForeignKey("dbo.INSCR_BQ_TOPICO_ATRIBUIDO", "Projeto_ProjetoId", "dbo.Projeto", "ProjetoId");
            AddForeignKey("dbo.INSCR_BQ_TOP_DISC_CARGO", "Projeto_ProjetoId", "dbo.Projeto", "ProjetoId");
            AddForeignKey("dbo.INSCR_BQ_QUESTAO_PROJETO", "Projeto_ProjetoId", "dbo.Projeto", "ProjetoId");
            AddForeignKey("dbo.INSCR_BQ_QUESTAO_PROJETO", "ID_QUESTAO_REVISADA", "dbo.INSCR_BQ_QUESTAO_REVISADA", "ID_QUESTAO_REVISADA");
            AddForeignKey("dbo.INSCR_BQ_QUESTAO_REVISADA", "ID_QUESTAO", "dbo.INSCR_BQ_QUESTAO", "ID_QUESTAO");
            AddForeignKey("dbo.INSCR_BQ_QUESTAO_RECICLAR_REVISOR", "Revisor_RevisorId", "dbo.Revisor", "RevisorId");
            AddForeignKey("dbo.INSCR_BQ_QUESTAO_RECICLAR_REVISOR", "ID_QUESTAO", "dbo.INSCR_BQ_QUESTAO", "ID_QUESTAO");
            AddForeignKey("dbo.INSCR_BQ_CONVITE_REVISOR", "Revisor_RevisorId", "dbo.Revisor", "RevisorId");
            AddForeignKey("dbo.INSCR_BQ_CONVITE_REVISOR", "ID_QUESTAO", "dbo.INSCR_BQ_QUESTAO", "ID_QUESTAO");
            AddForeignKey("dbo.INSCR_BQ_CONVITE_REVISAO_MESTRE", "ID_QUESTAO", "dbo.INSCR_BQ_QUESTAO", "ID_QUESTAO");
            AddForeignKey("dbo.INSCR_BQ_CONVITE_REVISAO_MESTRE", "ID_MESTRE", "dbo.INSCR_BQ_MESTRE", "ID_MESTRE");
            AddForeignKey("dbo.INSCR_BQ_CONVITE_MESTRE", "ID_MESTRE", "dbo.INSCR_BQ_MESTRE", "ID_MESTRE");
            AddForeignKey("dbo.INSCR_BQ_MESTRE", "ID_BANCA", "dbo.INSCR_BQ_BANCA", "ID_BANCA");
            AddForeignKey("dbo.INSCR_BQ_TOPICO_ATRIBUIDO", "INSCR_BQ_CARGO_CBO_ID_CARGO_CBO", "dbo.INSCR_BQ_CARGO_CBO", "ID_CARGO_CBO");
            AddForeignKey("dbo.INSCR_BQ_TOPICO_ATRIBUIDO", "Disciplina_DisciplinaId", "dbo.Disciplina", "DisciplinaId");
            AddForeignKey("dbo.INSCR_BQ_TOPICO_ATRIBUIDO", "AreaId", "dbo.Area", "AreaId");
            AddForeignKey("dbo.Disciplina", "INSCR_BQ_CARGO_CBO_ID_CARGO_CBO", "dbo.INSCR_BQ_CARGO_CBO", "ID_CARGO_CBO");
            AddForeignKey("dbo.INSCR_BQ_TOP_DISC_CARGO", "INSCR_BQ_CARGO_CBO_ID_CARGO_CBO", "dbo.INSCR_BQ_CARGO_CBO", "ID_CARGO_CBO");
            AddForeignKey("dbo.INSCR_BQ_TOP_DISC_CARGO", "Disciplina_DisciplinaId", "dbo.Disciplina", "DisciplinaId");
        }
    }
}
